...
public class UserAdd extends JFrame {
	...
	private void initialize() {
		setTitle("Dersane Projesi Kullanýcý Ekleme");
	...
	protected void btnUserAdd_Action_Performed(ActionEvent e) {
		...
		try {
			dao.kaydet(usr);
			JOptionPane.showMessageDialog(UserAdd.this, "Kayýt Baþarýlý...");

		} catch (Exception e1) {
			JOptionPane.showMessageDialog(UserAdd.this, "Kayýt Baþarýsýz oldu...!!!");
			e1.printStackTrace();
		}
	}
}
